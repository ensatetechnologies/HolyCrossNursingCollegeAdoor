        ...
        @foreach(Helper::languagesList() as $ActiveLanguage)
            @if($ActiveLanguage->box_status)
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('title_'.@$ActiveLanguage->code,Session::get('WebmasterSectionField')->{'title_'.@$ActiveLanguage->code}, array('placeholder' =>'','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                    </div>
                </div>
            @endif
        @endforeach
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="radio">
                    ...
                    <div style="margin-bottom: 5px;">
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('type','15',(Session::get('WebmasterSectionField')->type==15) ? true : false, array('id' => 'type15','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                    ...
                    <div style="margin-bottom: 5px;">
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('type','99',(Session::get('WebmasterSectionField')->type==99) ? true : false, array('id' => 'type99','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                            ...
                            @if($ActiveLanguage->box_status)
                                <div class="m-b-1">
                                    ...
                                    <div class="box p-a-xs">
                                        {!! Form::textarea('fixed_details_'.@$ActiveLanguage->code,Session::get('WebmasterSectionField')->{'details_'.@$ActiveLanguage->code}, array('ui-jp'=>"summernote",'placeholder' => '','class' => 'form-control summernote_' . @$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'ui-options'=>'{height: 150}')) !!}
                                    </div>
                                </div>
                            @endif
                        @endforeach

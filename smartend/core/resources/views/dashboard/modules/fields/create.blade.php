    ...
    <div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="radio">
                    ...
                    <div style="margin-bottom: 5px;">
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('type','15',false, array('id' => 'type15','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                    ...
                    <div style="margin-bottom: 5px;">
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('type','99',false, array('id' => 'type99','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                            ...
                            @if($ActiveLanguage->box_status)
                                <div class="m-b-1">
                                    ...
                                    <div class="box p-a-xs">
                                        {!! Form::textarea('fixed_details_'.@$ActiveLanguage->code,"", array('ui-jp'=>"summernote",'placeholder' => '','class' => 'form-control summernote_' . @$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'ui-options'=>'{height: 150}')) !!}
                                    </div>
                                </div>
                            @endif
                        @endforeach
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('in_table','1',false, array('id' => 'in_table1','class'=>'has-value')) !!}
                        <i class="dark-white"></i>
                        {{ __('backend.yes') }}
                    </label>
                    &nbsp; &nbsp;
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('in_table','0',true, array('id' => 'in_table2','class'=>'has-value')) !!}
                        <i class="dark-white"></i>
                        {{ __('backend.no') }}
                    </label>
                </div>
        ...
        @if($WebmasterSections->type != 4)
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="radio">
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('in_listing','1',false, array('id' => 'in_listing1','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                            {{ __('backend.yes') }}
                        </label>
                        &nbsp; &nbsp;
                        <label class="ui-check ui-check-md">
                            {!! Form::radio('in_listing','0',true, array('id' => 'in_listing2','class'=>'has-value')) !!}
                            <i class="dark-white"></i>
                            {{ __('backend.no') }}
                        </label>
                    </div>
